...
#else
#define MOT_ENC_LINES			0x1000		/**< Lines of encoder */
#endif
...
/// Brakes
#define BRAKE_RELEASE_CMD       0x61
#define BRAKE_STATE             0x62
...
#define CAN_READ_TIMEOUT 30000  /** can bus read data timeout. CANBUS HZ */
